...
class TrainResults(object):
    ...
    def plot_total_loss(self, filename):
        x_vals = np.arange(len(self.total_losses))
        plt.plot(x_vals, self.total_losses, label="Train Loss")
        plt.xlabel("Train Steps")
        plt.ylabel("Loss")
        plt.savefig(f"{filename}_total_loss.pdf")

    def plot_individual_losses(self, filename):
        x_vals = np.arange(len(self.total_losses))
        ...
        plt.ylabel("Losses")
        plt.legend()
        plt.savefig(f"{filename}_losses.pdf")
        plt.show()

    def plot_policy_loss(self, filename):
        x_vals = np.arange(len(self.total_losses))
        plt.plot(x_vals, self.policy_losses, label="Policy Loss")
        plt.xlabel("Train Steps")
        plt.ylabel("Losses")
        plt.legend()
        plt.savefig(f"{filename}_policy_loss.pdf")
